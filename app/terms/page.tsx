...
export const metadata: Metadata = {
  title: "Terms of Service — DevEx Tools Team",
  description:
    "Read the Terms of Service for DevEx Tools Team. By using our directory platform, you agree to these terms governing your use of the website and services.",
};
      ...
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="space-y-8 text-[#8BA3BE] leading-relaxed">
          <section>
            ...
            <p>
              By accessing or using the DevEx Tools Team website (the "Site"), you agree to be
          ...
          <section>
            ...
            <p>
              DevEx Tools Team is a curated directory platform that provides information,
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              content — are owned by DevEx Tools Team and are protected by international
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              of DevEx Tools Team. We reserve the right to moderate, edit, or remove reviews
          ...
          <section>
            ...
            <p>
              ...
              controlled by DevEx Tools Team. We have no control over, and assume no
          ...
          <section>
            ...
            <p>
              DevEx Tools Team offers free access to our directory and comparison features.
          ...
          <section>
            ...
            <p>
              To the fullest extent permitted by law, DevEx Tools Team, its officers, directors,
          ...
          <section>
            ...
            <p>
              You agree to indemnify, defend, and hold harmless DevEx Tools Team and its
