...
export const metadata: Metadata = {
  title: "Terms of Service — Isle Works DevEx",
  description:
    "Read the Terms of Service for Isle Works DevEx. By using our directory platform, you agree to these terms governing your use of the website and services.",
};
      ...
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="space-y-8 text-[#8BA3BE] leading-relaxed">
          <section>
            ...
            <p>
              By accessing or using the Isle Works DevEx website (the "Site"), you agree to be
          ...
          <section>
            ...
            <p>
              Isle Works DevEx is a curated directory platform that provides information,
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              content — are owned by Isle Works DevEx and are protected by international
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              of Isle Works DevEx. We reserve the right to moderate, edit, or remove reviews
          ...
          <section>
            ...
            <p>
              ...
              controlled by Isle Works DevEx. We have no control over, and assume no
          ...
          <section>
            ...
            <p>
              Isle Works DevEx offers free access to our directory and comparison features.
          ...
          <section>
            ...
            <p>
              To the fullest extent permitted by law, Isle Works DevEx, its officers, directors,
          ...
          <section>
            ...
            <p>
              You agree to indemnify, defend, and hold harmless Isle Works DevEx and its
          ...
          <section>
            ...
            <div className="mt-4 p-5 bg-[#0F1D32] border border-[#1E3A5F] rounded-xl">
              <p className="mb-2"><strong className="text-[#F0F4F8]">Email:</strong> legal@devex-tools.net</p>
              <p className="mb-2"><strong className="text-[#F0F4F8]">Support:</strong> support@devex-tools.net</p>
              <p><strong className="text-[#F0F4F8]">Address:</strong> 400 1st Ave S, Suite 300, Seattle, WA 98104</p>
            </div>
          </section>
        </div>
      </div>
